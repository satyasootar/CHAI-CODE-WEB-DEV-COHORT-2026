...
export function maskAadhaar(aadhaarNumber) {
  ...
  let lastFourDigit =  aadhaarNumber.slice(aadhaarNumber.length - 4)
  let masked = "X".repeat(8)
  let first = masked.slice(0,4)
  let second = masked.slice(4)

  return `${first}-${second}-${lastFourDigit}`
}
