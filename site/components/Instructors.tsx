...
export function Instructors() {
  ...
  return (
    <div className="mt-16 mb-8 flex w-full max-w-5xl flex-col justify-center px-4 sm:mt-36 sm:items-center">
      ...
      <div className="flex w-full flex-col md:flex-row md:gap-8 lg:gap-12 items-center md:items-stretch">
