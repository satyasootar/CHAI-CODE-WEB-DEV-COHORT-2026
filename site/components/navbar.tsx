      ...
      >
        <div className="relative w-full max-w-6xl mx-auto flex h-16 py-10 items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-row items-end justify-center pt-2">
              <div className="w-10">
                <svg
                  ...
                  className="-ml-1.5 h-10 w-10 fill-[#B0B0B0] stroke-[#B0B0B0] dark:fill-[#ffffff] dark:stroke-[#ffffff]"
                >
                  <path
                    ...
                    fill="#FF7D0C"
                    style={{
                      transform: "translateY(4.92396px) scaleX(0.980304)",
                  ...
                  <path
                    ...
                    fill="#FE9332"
                    style={{
                      transform: "translateY(0.624335px) scaleX(1.00416)",
                      transformOrigin: "50% 50%",
                      transformBox: "fill-box",
                    }}
                  ></path>
              ...
              <span className={`text-3xl font-bold ml-2 transition-colors duration-300 ${isOpen ? "text-foreground" : "text-foreground"}`}>
                satyacode
              </span>
            </div>
          </Link>
          ...
          <button
            ...
            className="z-50 p-2 focus:outline-none mix-blend-difference text-white"
